				...
				for lr in learning_rates:
					for dr in dropout_rates:
						for bs in batch_sizes:
							bashCommand = f"python3 main.py -m {model} -ef {eeg_feature} -ntt {number_test_target} -bs {bs} -hc {hidden_channel} -lr {lr} -dr {dr} -st -wtr -esp 30 -trd test2 -tmd best_params_2"
